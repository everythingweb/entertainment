      ...
      <main className="relative z-10 flex flex-col lg:flex-row items-center justify-center min-h-screen p-8 pt-0 md:pt-0 lg:pt-0 gap-8">
        <section className="flex flex-col md:flex-row justify-between items-center px-4 sm:px-6 lg:px-8 pt-10 pb-10 container mx-auto">
          <div className="w-full md:w-1/2 space-y-8">
            <div>
              <div className="flex items-center gap-2 bg-[#474a58] w-fit px-4 py-2 rounded-full hover:bg-[#5a5d6a] transition-colors cursor-pointer group">
            ...
            <div className="flex gap-3 max-w-md">
              <input
                ...
                className="flex-1 px-6 py-4 border border-gray-700 rounded-xl focus:outline-none focus:border-[#66D7AE] focus:ring-2 focus:ring-[#66D7AE] transition-all text-white bg-gray-900"
                type="email"
                value={email}
                onChange={handleEmailChange}
              />
              <button
                className="bg-[#66D7AE] text-gray-950 px-8 py-4 rounded-xl hover:bg-teal-500 cursor-pointer transition-all hover:shadow-lg hover:shadow-teal-900 active:scale-95"
